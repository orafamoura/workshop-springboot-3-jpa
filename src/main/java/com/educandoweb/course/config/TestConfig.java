...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception { // tudo que colocar dentro desse metodo run vai ser executado junto da aplicacao
		...
		Order o2 = new Order(null, Instant.parse("2019-07-20T03:42:10Z"), u2, OrderStatus.PAID);
		Order o3 = new Order(null, Instant.parse("2019-07-20T15:21:22Z"), u1, OrderStatus.PAID);
		...
		//associacao de mao dupla em memoria
		o1.setPayment(pay1);
